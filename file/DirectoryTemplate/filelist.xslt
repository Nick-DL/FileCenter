      ...
      <head>
        ...
        <style type="text/css">
          ...
          @media (prefers-color-scheme: dark) {
            ...
            .mdui-color-blue-grey-50 { background-color: #37474F !important; }
      ...
      <body class="mdui-loaded mdui-theme-layout-auto">
        <div class="mdui-appbar mdui-shadow-0">
          <div class="mdui-toolbar">
            <a href="../" class="mdui-btn mdui-btn-icon mdui-ripple mdui-hidden-md-up" mdui-tooltip="{{content: 'Back', delay: 500}}"><i class="mdui-icon material-icons">&#xe5c4;</i></a>
